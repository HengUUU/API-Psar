...
exports.ProductCategorySeeder = void 0;
const productCategory_model_1 = require("../../models/store/productCategory.model");
class ProductCategorySeeder {
    ...
    static async seedInventory() {
        try {
            await productCategory_model_1.ProductCategory.bulkCreate(ProductCategories);
...
exports.ProductCategorySeeder = ProductCategorySeeder;
...
//# sourceMappingURL=productCategory.seed.js.map