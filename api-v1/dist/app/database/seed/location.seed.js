...
exports.LocationSeeder = void 0;
const location_model_1 = require("../../models/user/location.model");
class LocationSeeder {
    ...
    static async seedLocation() {
        try {
            await location_model_1.default.bulkCreate(locations);
